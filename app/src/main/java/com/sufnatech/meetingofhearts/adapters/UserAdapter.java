package com.sufnatech.meetingofhearts.adapters;
...
import com.sufnatech.meetingofhearts.ui.ProfileActivity;
    ...
    class UserVH extends RecyclerView.ViewHolder {
        ...
        public UserVH(@NonNull final View itemView) {
            ...
            ic_start_chat.setOnClickListener(view -> {
                User user = userList.get(getAdapterPosition());
                Map<String, String> users_pair = new HashMap<>();
                users_pair.put(current_user_ID, current_uid);
                users_pair.put(user.getID(), user.getUid());
                ...
                conversationRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot snap : snapshot.getChildren()){
                            ...
                            Map<String, String> map = conversation.getUsers();
                            if(map.equals(users_pair)){
